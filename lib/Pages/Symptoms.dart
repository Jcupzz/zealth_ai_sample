                              ...
                              child: ElevatedButton(
                                onPressed: () {
                                  if (inputChips.isNotEmpty) {
                                    if (isFatigueOnceSelected&&isVomitingOnceSelected) {
                                      isBothSelected = true;
                                      print("HURAASRSR");
                                ...
                                child: Text('Check',
                                    style:
                                        GoogleFonts.poppins(fontSize: 11, color: Color(0xffFF0270), fontWeight: FontWeight.w500)),
